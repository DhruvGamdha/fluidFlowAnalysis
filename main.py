...
if __name__ == "__main__":
    ...
    analysis.markBubblesOnFrames(outpDirObj.getDirPathObj('binary/all/frames'), outpDirObj.getDirPathObj('analysis/bubbleTracking/frames'))
    analysis.createVideoFromFrames(outpDirObj.getDirPathObj('analysis/bubbleTracking/frames'))
    analysis.createConcatVideo(inpDirObj.getDirPathObj('all/frames'), outpDirObj.getDirPathObj('analysis/bubbleTracking/frames'), outpDirObj.getDirPathObj('analysis/bubbleTracking/frames').parent)